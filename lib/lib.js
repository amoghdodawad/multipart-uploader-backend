            ...
            if (totalChunks === uploadedChunks) {
                try {
                    ...
                    for(let i = 0; i < totalChunks; ++i){
                        await appendToFile(`${this.#videoDirectory}/${uploadId}/${uploadId}.${this.#files[req.body.uploadId].extension}`, await readFromFile(`${this.#chunksDirectory}/${uploadId}/${i}.mp4`));
                    }
